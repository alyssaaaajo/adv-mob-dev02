// mapStyles.ts - Custom map style configurations
...
// Export all styles with names for easy switching
...
export type MapStyleType = keyof typeof mapStyles;